# Anatomy of run `20260830T101735-34789a`
...
**full-system** · 123 events · 99 ms wall · 4 model calls · RM 0.0082
...
| `allowed` | 26 | a guardrail permitted an action |
| `denied` | 3 | a guardrail refused an action |
| `engine` | 46 | a deterministic engine computed something |
...
| a9_attribution | agent | 4.5 |
| a0_supervisor | agent | 2.2 |
| inference | span | 1.9 |
| markets | span | 1.3 |
| portfolio | span | 1.2 |
| a13_sizing | agent | 0.9 |
| config | span | 0.7 |
