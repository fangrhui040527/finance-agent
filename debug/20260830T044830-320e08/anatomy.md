# Anatomy of run `20260830T044830-320e08`
...
**full-system** · 106 events · 56 ms wall · 4 model calls · RM 0.0082
...
| `a7_sector_technology` | 0 | 0 | 0 | 0 | 0 | 0.0000 | 0 |
...
| Kind | Count | Means |
|---|--:|---|
| `agent` | 8 | an agent method ran |
| `allowed` | 23 | a guardrail permitted an action |
| `denied` | 3 | a guardrail refused an action |
| `engine` | 39 | a deterministic engine computed something |
...
| `span_end` | 15 | a named stage finished |
...
|---|---|--:|
| registry | span | 42.0 |
| a9_attribution | agent | 4.4 |
| inference | span | 2.1 |
| a0_supervisor | agent | 2.0 |
| markets | span | 1.4 |
| portfolio | span | 1.2 |
| a13_sizing | agent | 0.7 |
| config | span | 0.7 |
| thesis_and_red_team | span | 0.5 |
| a15_reflection | agent | 0.4 |
