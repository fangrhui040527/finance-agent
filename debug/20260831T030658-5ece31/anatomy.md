# Anatomy of run `20260831T030658-5ece31`
...
**full-system** · 134 events · 89 ms wall · 4 model calls · RM 0.0082
...
|---|---|--:|
| registry | span | 36.9 |
| a7_sector_technology | agent | 34.9 |
| a9_attribution | agent | 4.0 |
| markets | span | 3.1 |
| config | span | 2.2 |
| inference | span | 1.8 |
| portfolio | span | 1.5 |
| a0_supervisor | agent | 1.2 |
| a13_sizing | agent | 1.2 |
| a15_reflection | agent | 0.5 |
