# Anatomy of run `20260902T143254-5b299d`
...
**full-system** · 134 events · 178 ms wall · 4 model calls · RM 0.0082
...
| Stage | Kind | ms |
|---|---|--:|
| a7_sector_technology | agent | 34.1 |
| registry | span | 27.6 |
| a9_attribution | agent | 3.0 |
| markets | span | 3.0 |
| portfolio | span | 2.8 |
| a13_sizing | agent | 2.6 |
| inference | span | 2.0 |
| a0_supervisor | agent | 0.9 |
| config | span | 0.8 |
| thesis_and_red_team | span | 0.3 |
