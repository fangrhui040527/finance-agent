# Anatomy of run `20260903T160925-abc53b`
...
**full-system** · 134 events · 127 ms wall · 4 model calls · RM 0.0080
...
|---|---|--:|
| registry | span | 49.2 |
| a7_sector_technology | agent | 37.7 |
| config | span | 6.8 |
| a9_attribution | agent | 4.7 |
| portfolio | span | 4.5 |
| markets | span | 4.3 |
| a13_sizing | agent | 4.1 |
| inference | span | 3.3 |
| a0_supervisor | agent | 1.6 |
