# Anatomy of run `20260902T112858-12668a`
...
**full-system** · 134 events · 133 ms wall · 4 model calls · RM 0.0082
...
|---|---|--:|
| registry | span | 56.9 |
| a7_sector_technology | agent | 52.6 |
| a9_attribution | agent | 5.8 |
| markets | span | 5.1 |
| portfolio | span | 2.6 |
| a0_supervisor | agent | 2.6 |
| inference | span | 2.4 |
