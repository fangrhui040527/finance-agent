# Anatomy of run `20260831T083520-5963bf`
...
**full-system** · 134 events · 160 ms wall · 4 model calls · RM 0.0021
...
|---|---|--:|
| registry | span | 61.4 |
| a7_sector_technology | agent | 49.7 |
| markets | span | 6.7 |
| config | span | 5.5 |
| a9_attribution | agent | 5.1 |
| portfolio | span | 4.1 |
| a13_sizing | agent | 3.8 |
| inference | span | 3.3 |
