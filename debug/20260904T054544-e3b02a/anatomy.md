# Anatomy of run `20260904T054544-e3b02a`
...
**full-system** · 134 events · 142 ms wall · 4 model calls · RM 0.0080
...
|---|---|--:|
| registry | span | 46.7 |
| a7_sector_technology | agent | 40.6 |
| config | span | 21.8 |
| a9_attribution | agent | 5.0 |
| portfolio | span | 4.8 |
| a13_sizing | agent | 4.4 |
| markets | span | 4.4 |
| inference | span | 3.6 |
