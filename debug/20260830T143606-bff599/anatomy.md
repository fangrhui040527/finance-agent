# Anatomy of run `20260830T143606-bff599`
...
**full-system** · 134 events · 142 ms wall · 4 model calls · RM 0.0082
...
|---|---|--:|
| registry | span | 59.5 |
| a7_sector_technology | agent | 56.0 |
| a9_attribution | agent | 6.6 |
| markets | span | 5.6 |
| portfolio | span | 2.8 |
| inference | span | 2.8 |
| a0_supervisor | agent | 2.7 |
| a13_sizing | agent | 2.2 |
| config | span | 1.0 |
| thesis_and_red_team | span | 0.9 |
