# Anatomy of run `20260904T044835-809a65`
...
**full-system** · 134 events · 145 ms wall · 4 model calls · RM 0.0080
...
|---|---|--:|
| registry | span | 55.9 |
| a7_sector_technology | agent | 44.9 |
| config | span | 5.7 |
| a9_attribution | agent | 5.7 |
| portfolio | span | 5.7 |
| markets | span | 5.3 |
| a13_sizing | agent | 5.3 |
| inference | span | 4.2 |
| a0_supervisor | agent | 1.9 |
| thesis_and_red_team | span | 0.8 |
