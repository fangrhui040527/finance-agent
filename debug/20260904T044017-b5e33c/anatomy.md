# Anatomy of run `20260904T044017-b5e33c`
...
**full-system** · 134 events · 120 ms wall · 4 model calls · RM 0.0080

## Organs — what fired

| Agent | Invocations | Model calls | Retrievals | Tools used | Denied | Cost MYR | ms |
|---|--:|--:|--:|--:|--:|--:|--:|
| `a0_supervisor` | 1 | 0 | 0 | 4 | 1 | 0.0000 | 0 |
| `a10_thesis` | 1 | 1 | 0 | 3 | 0 | 0.0025 | 0 |
| `a11_red_team` | 1 | 1 | 0 | 2 | 0 | 0.0025 | 0 |
| `a12_portfolio_risk` | 1 | 0 | 0 | 1 | 0 | 0.0000 | 0 |
| `a13_sizing` | 1 | 0 | 0 | 1 | 0 | 0.0000 | 0 |
| `a14_teacher` | 1 | 0 | 0 | 1 | 0 | 0.0000 | 0 |
| `a15_reflection` | 1 | 1 | 0 | 2 | 0 | 0.0025 | 0 |
...
| `engine` | 54 | a deterministic engine computed something |
...
|---|---|--:|
| registry | span | 47.8 |
| a7_sector_technology | agent | 36.9 |
| config | span | 4.8 |
| a9_attribution | agent | 4.7 |
| markets | span | 4.4 |
| inference | span | 3.4 |
| portfolio | span | 3.4 |
| a13_sizing | agent | 3.0 |
| a0_supervisor | agent | 1.8 |
| thesis_and_red_team | span | 0.6 |
