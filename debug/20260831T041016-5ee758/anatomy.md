# Anatomy of run `20260831T041016-5ee758`
...
**full-system** · 134 events · 150 ms wall · 4 model calls · RM 0.0082
...
|---|---|--:|
| registry | span | 53.8 |
| a7_sector_technology | agent | 49.0 |
| a9_attribution | agent | 5.5 |
| markets | span | 4.1 |
| inference | span | 3.3 |
| config | span | 2.8 |
| portfolio | span | 2.1 |
| a13_sizing | agent | 1.7 |
