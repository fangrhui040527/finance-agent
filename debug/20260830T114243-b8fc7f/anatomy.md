# Anatomy of run `20260830T114243-b8fc7f`
...
**full-system** · 126 events · 69 ms wall · 4 model calls · RM 0.0082
...
| `engine` | 49 | a deterministic engine computed something |
...
|---|---|--:|
| registry | span | 29.7 |
| a7_sector_technology | agent | 28.5 |
| a9_attribution | agent | 3.0 |
| markets | span | 1.6 |
| inference | span | 1.4 |
| a0_supervisor | agent | 1.4 |
| portfolio | span | 0.9 |
| a13_sizing | agent | 0.6 |
| config | span | 0.6 |
| thesis_and_red_team | span | 0.4 |
