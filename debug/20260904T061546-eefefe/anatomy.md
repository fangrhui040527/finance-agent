# Anatomy of run `20260904T061546-eefefe`
...
**full-system** · 134 events · 138 ms wall · 4 model calls · RM 0.0080
...
|---|---|--:|
| registry | span | 46.9 |
| a7_sector_technology | agent | 38.0 |
| config | span | 21.6 |
| a9_attribution | agent | 4.6 |
| portfolio | span | 4.5 |
| markets | span | 4.5 |
| a13_sizing | agent | 4.2 |
| inference | span | 3.5 |
| a0_supervisor | agent | 1.5 |
