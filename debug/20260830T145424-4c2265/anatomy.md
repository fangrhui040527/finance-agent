# Anatomy of run `20260830T145424-4c2265`
...
**full-system** · 134 events · 123 ms wall · 4 model calls · RM 0.0082
...
|---|---|--:|
| registry | span | 53.7 |
| a7_sector_technology | agent | 46.1 |
| markets | span | 5.5 |
| a9_attribution | agent | 5.3 |
| inference | span | 2.5 |
| a0_supervisor | agent | 2.4 |
| portfolio | span | 2.3 |
| a13_sizing | agent | 1.9 |
| config | span | 0.8 |
