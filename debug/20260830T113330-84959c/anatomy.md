# Anatomy of run `20260830T113330-84959c`
...
**full-system** · 126 events · 81 ms wall · 4 model calls · RM 0.0082
...
|---|---|--:|
| registry | span | 36.1 |
| a7_sector_technology | agent | 32.1 |
| a9_attribution | agent | 3.7 |
| markets | span | 2.0 |
| a0_supervisor | agent | 1.7 |
| inference | span | 1.6 |
| portfolio | span | 1.0 |
